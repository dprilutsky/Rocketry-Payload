...
void draw(){
  ...
  fill(255);
  text(nfs(floor(time/60),2,0)+":"+nfs(time%60,2,2),displayWidth*4/5+40,177);
  text(nfs(latitude,2,6)+"°N " + nfs(longitude,2,6) + "°W", displayWidth/3+100, 177);
